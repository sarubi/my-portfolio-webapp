    ...
    <div className="work-experience mt-[30px]">
      ...
      <div className="bio-details flex-row">
        ...
        <div className="flex row mb-[5px]">
          ...
          <div className="bio-item-time min-w-[110px]">2021 - 2022:</div>
          <div className="bio-item-description">
          ...
          <div className="bio-item-time min-w-[110px]">2020 - 2021:</div>
          <div className="bio-item-description">
        ...
        <div className="flex row mb-[5px]">
          ...
          <div className="bio-item-time min-w-[110px]">2019 - 2020:</div>
          <div className="bio-item-description">
        ...
        <div className="flex row mb-[5px]">
          ...
          <div className="bio-item-time min-w-[110px]">2018 - 2019:</div>
          <div className="bio-item-description">
        ...
        <div className="flex row mb-[5px]">
          ...
          <div className="bio-item-time min-w-[110px]">2016 - 2017:</div>
          <div className="bio-item-description">
